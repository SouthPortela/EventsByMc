...
public class RegistrarUsuarioUseCase {
    ...
    public void registrarUsuario(String nome, String email, String senhaUsuario) {
        registrarUsuario(nome, email, senhaUsuario, Perfil.PARTICIPANTE);
    }

    public void registrarUsuario(String nome, String email, String senhaUsuario, Perfil perfil) {
        if (perfil != Perfil.PARTICIPANTE && perfil != Perfil.ORGANIZADOR) {
            throw new IllegalArgumentException("O cadastro aceita apenas participante ou organizador.");
        }
        ...
        Usuario usuario = new Usuario(pessoa, senha.getHash(), perfil);
